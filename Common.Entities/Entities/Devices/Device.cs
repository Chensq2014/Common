...
namespace Common.Entities
{
    ...
    public class Device : BaseEntity
    {
        ...
        /// 名称
        /// </summary>
        [MaxLength(CommonConsts.MaxLength64), Description("名称")]
        ...
        /// </summary>
        [Required]
        [MaxLength(CommonConsts.MaxLength64), Description("设备编码")]
        ...
        /// </summary>
        [Required]
        [MaxLength(CommonConsts.MaxLength64), Description("转发编码")]
        ...
        /// </summary>
        [Required]
        [MaxLength(CommonConsts.MaxLength255), Description("设备唯一密钥")]
        public string Key { get; set; }

        /// <summary>
        /// 备案号
        /// </summary>
        [MaxLength(CommonConsts.MaxLength64), Description("备案号")]
        ...
        /// 父级区域（省）
        /// </summary>
        [MaxLength(CommonConsts.MaxLength16), Description("父级区域(省)")]
        ...
        /// </summary>
        [Required]
        [MaxLength(CommonConsts.MaxLength16), Description("项目区域(市)")]
        public string Area { get; set; }

        /// <summary>
        /// 子区域(区/县)
        /// </summary>
        [MaxLength(CommonConsts.MaxLength16), Description("子区域(区/县)")]
