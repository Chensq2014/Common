...
namespace Common.Entities
{
    ...
    public class LicenseResource : BaseEntity
    {
        ...
        /// 资源名称
        /// </summary>
        [Description("资源名称"), MaxLength(CommonConsts.MaxLength64)]
        public string Name { get; set; }

        /// <summary>
        /// 资源Code确保唯一性
        /// </summary>
        [Description("资源Code确保唯一性"), MaxLength(CommonConsts.MaxLength64)]
        ...
        /// </summary>
        [Description("如果类型为1=webApi，那么将匹配请求资源路由，支持正则表达式，如：^/api.*"), MaxLength(CommonConsts.MaxLength255)]
