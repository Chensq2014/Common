...
namespace Common.ValueObjects
{
    ...
    public class Attachment : ValueObject
    {
        ...
        /// </summary>
        [MaxLength(CommonConsts.MaxLength255),Description("文件名"), NotSet]
        public string Name { get; set; }

        /// <summary>
        ///     文件扩展名 Path.HasValue() ? Path.GetExtension(Path)?.ToLower() : string.Empty;
        /// </summary>
        [MaxLength(CommonConsts.MaxLength128),Description("扩展名"), NotSet]
        ...
        /// </summary>
        [MaxLength(CommonConsts.MaxLength255),Description("文件绝对路径")]
        public string Path { get; set; }

        /// <summary>
        ///     扩展字段:文件虚拟路径（相对路径备用）
        /// </summary>
        [MaxLength(CommonConsts.MaxLength255),Description("虚拟路径")]
