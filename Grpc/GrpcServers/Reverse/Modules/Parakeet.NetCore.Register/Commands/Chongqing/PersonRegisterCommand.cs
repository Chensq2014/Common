...
namespace Parakeet.NetCore.Register.Commands.Chongqing
{
        ...
        public async Task<ResponseWrapper<string>> ExecuteAsync(DeviceDto device, string body)
        {
            ...
            try
            {
                ...
                await producer.PublishAsync(wrapperData,
                    $"{AppConstants.CHONGQING}.{AppConstants.GATE}.{AppConstants.REGISTER_HANDLER_TYPE}"); //.ConfigureAwait(false);
