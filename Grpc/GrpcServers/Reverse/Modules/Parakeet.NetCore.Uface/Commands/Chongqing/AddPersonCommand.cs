...
using Parakeet.NetCore.Uface.Extensions;
...
namespace Parakeet.NetCore.Uface.Commands.Chongqing
{
    /// <summary>
    /// 向设备下发人员
    /// </summary>
    public class AddPersonCommand : BaseHandlerType, IReverseCommand
    {
        ...
        public string Name => AppConstants.ADD_PERSON_FACE_COMMAND;
        public string Area => AppConstants.CHONGQING;
        public string SupplierCode => AppConstants.UFACE;
