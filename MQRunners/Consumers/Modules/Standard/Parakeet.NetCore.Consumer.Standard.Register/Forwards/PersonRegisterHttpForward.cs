...
using Parakeet.NetCore.Consumer.Forwards;
...
using Parakeet.NetCore.Caches;
using Parakeet.NetCore.Consumer.Standard.Dtos;
using Parakeet.NetCore.Consumer.Standard.Services;
...
using TokenResultDto = Parakeet.NetCore.Consumer.Standard.Dtos.TokenResultDto;

namespace Parakeet.NetCore.Consumer.Standard.RegisterModule.Forwards
{
    /// <summary>
    /// standard人员注册转发器
    /// </summary>
    public class PersonRegisterHttpForward : HttpForward<DeviceWorkerDto>, IPersonRegisterHttpForward
    {
            ...
            string receiveUrl = null)
        {
            ...
            return $"{receiveUrl}?access_token={tokenResult.Data.Access_token}";
        }
    }
}
