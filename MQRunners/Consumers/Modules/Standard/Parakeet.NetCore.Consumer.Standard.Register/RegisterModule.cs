...
using Parakeet.NetCore.Consumer.Standard.RegisterModule.Forwards;
...
namespace Parakeet.NetCore.Consumer.Standard.RegisterModule
{
    /// <summary>
    /// Standard注册模块【存储/转发的消费者可以写在一起】
    /// </summary>
