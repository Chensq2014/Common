...
namespace Parakeet.NetCore.ConsumerServer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Parakeet NetCore Platform Consumer Server";
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                //    collection.AddApplication<ConsumerServerModule>(options =>
                //    {
                ...
                .ConfigureWebHostDefaults(webBuilder =>
                {
                    ...
                    webBuilder.UseUrls("https://localhost:5010;http://localhost:5009");
                })
#if DEBUG
