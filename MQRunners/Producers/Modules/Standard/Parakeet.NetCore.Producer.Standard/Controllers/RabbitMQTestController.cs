...
using Parakeet.NetCore.Controllers;
using Parakeet.NetCore.Dtos;
using Parakeet.NetCore.Entities;
using Parakeet.NetCore.Producer.Standard.Confirm;
using Parakeet.NetCore.Producer.Standard.DCL;
using Parakeet.NetCore.Producer.Standard.Delay;
using Parakeet.NetCore.Producer.Standard.Direct;
using Parakeet.NetCore.Producer.Standard.Fanout;
using Parakeet.NetCore.Producer.Standard.Topic;
using Parakeet.NetCore.Producer.Standard.Worker;
...
namespace Parakeet.NetCore.Producer.Standard.Controllers
{
    /// <summary>
    /// RabbitMqTest api 
    /// </summary>
